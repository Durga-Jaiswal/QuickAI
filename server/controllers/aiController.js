...
export const generateArticle = async (req, res) => {
    try {
        ...
        if (plan !== "premium" && free_usage >= 10) {
            return res.json({ success: false, message: "Limit reached. Upgrage to premium plan" })
        }
...
export const resumeReview = async (req, res) => {
    try {
        ...
        const prompt = `Review the following resume and provide the constructive feedback on its strength and weakness and areas of improvement. Resume content: \n\n ${pdfData.text}`
